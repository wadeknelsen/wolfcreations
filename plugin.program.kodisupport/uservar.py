...
BUILDFILE      = 'https://raw.githubusercontent.com/wadeknelsen/wolfcreations/master/wizard/buildsfile.txt'
...
THEME1         = '[COLOR '+COLOR1+'][B][I]([COLOR '+COLOR2+']Kodi Support[/COLOR])[/B][/COLOR] [COLOR '+COLOR2+']%s[/COLOR][/I]'
